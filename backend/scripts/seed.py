...
async def seed():
    ...
    async with async_session() as db:
        ...
        db.add(ws)
        ws2 = ClientWorkspace(
            agency_id=agency.id, name="Infrastructure Projects", description="Infrastructure and construction"
        )
        db.add(ws2)
        await db.flush()
        ...
        tenders_data = [
            (
                "Regional Hospital IT System Upgrade",
                "RFP-2024-001",
            ...
            (
                "City Bridge Maintenance Contract",
                "RFP-2024-002",
            ...
            (
                "County Health Records Digitization",
                "RFP-2024-005",
